  ...
  <div style={{ display: 'flex', alignItems: 'center', flexShrink: '0', minWidth: '0px', maxWidth: '100%', height: '18px', borderRadius: '3px', paddingLeft: '6px', paddingRight: '6px', fontSize: '12px', lineHeight: '120%', color: 'rgb(253 253 253 / 80%)', background: 'rgb(0, 128, 0)', margin: '0px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
    <div style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'inline-flex', alignItems: 'center', height: '18px', lineHeight: '18px' }}>
      <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>2 créditos</span>
        ...
        <div className="course-info" style={{ left: '519px', top: '750px' }}>Ondulatória e Física Térmica para Engenharia<br /></div>
        ...
        <div><div className="course-info" style={{ left: '519px', top: '885px' }}>Laboratório de Ondulatória e Física Térmica</div></div>
        <div className="course-info" style={{ left: '519px', top: '920px', display: 'flex', flexWrap: 'wrap', gap: '4px 6px', position: 'absolute' }}>
            <div style={{ display: 'flex', alignItems: 'center', flexShrink: '0', minWidth: '0px', maxWidth: '100%', height: '18px', borderRadius: '3px', paddingLeft: '6px', paddingRight: '6px', fontSize: '12px', lineHeight: '120%', color: 'rgb(253 253 253 / 80%)', background: 'rgb(110, 54, 48)', margin: '0px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
              <div style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'inline-flex', alignItems: 'center', height: '18px', lineHeight: '18px' }}>
                <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>2 créditos</span>
              </div>
          ...
          <div><div className="course-card" style={{ left: '505px', top: '1005px' }}></div></div>
        <div><div className="course-info" style={{ left: '519px', top: '1020px' }}>Introdução ao Design e Concepção de Veículos</div></div>
        <div className="course-info" style={{ left: '519px', top: '1055px', display: 'flex', flexWrap: 'wrap', gap: '4px 6px', position: 'absolute' }}>
            <div style={{ display: 'flex', alignItems: 'center', flexShrink: '0', minWidth: '0px', maxWidth: '100%', height: '18px', borderRadius: '3px', paddingLeft: '6px', paddingRight: '6px', fontSize: '12px', lineHeight: '120%', color: 'rgb(253 253 253 / 80%)', background: 'rgb(110, 54, 48)', margin: '0px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
              <div style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'inline-flex', alignItems: 'center', height: '18px', lineHeight: '18px' }}>
                <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>4 créditos</span>
              </div>
        ...
        <div className="course-info" style={{ left: '760px', top: '750px' }}>Engenharia Econômica<br /></div>
        ...
        <div><div className="course-info" style={{ left: '760px', top: '885px' }}>Ergonomia do Produto</div></div>
        ...
        <div><div className="course-info" style={{ left: '760px', top: '1020px' }}>Humanidades e Cidadania</div></div>
        <div className="course-info" style={{ left: '760px', top: '1040px', display: 'flex', flexWrap: 'wrap', gap: '4px 6px', position: 'absolute' }}>
            <div style={{ display: 'flex', alignItems: 'center', flexShrink: '0', minWidth: '0px', maxWidth: '100%', height: '18px', borderRadius: '3px', paddingLeft: '6px', paddingRight: '6px', fontSize: '12px', lineHeight: '120%', color: 'rgb(253 253 253 / 80%)', background: 'rgb(110, 54, 48)', margin: '0px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
              <div style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'inline-flex', alignItems: 'center', height: '18px', lineHeight: '18px' }}>
                <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>4 créditos</span>
              </div>
        ...
        <div><div className="course-info" style={{ left: '998px', top: '345px' }}>Tecnologias de Fabricação 1<br /></div></div>
        <div className="course-info" style={{ left: '998px', top: '365px', display: 'flex', flexWrap: 'wrap', gap: '4px 6px', position: 'absolute' }}>
            <div style={{ display: 'flex', alignItems: 'center', flexShrink: '0', minWidth: '0px', maxWidth: '100%', height: '18px', borderRadius: '3px', paddingLeft: '6px', paddingRight: '6px', fontSize: '12px', lineHeight: '120%', color: 'rgb(253 253 253 / 80%)', background: 'rgb(110, 54, 48)', margin: '0px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
              <div style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'inline-flex', alignItems: 'center', height: '18px', lineHeight: '18px' }}>
                <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>4 créditos</span>
              </div>
        ...
        <div><div className="course-info" style={{ left: '998px', top: '615px' }}>Mecânica dos Sólidos 2<br /></div></div>
        ...
        <div className="course-info" style={{ left: '998px', top: '750px' }}> Gestão da Produção e Qualidade<br /></div>
        ...
        <div><div className="course-info" style={{ left: '998px', top: '885px' }}>Métodos Experimentais para Engenharia</div></div>
        ...
        <div><div className="course-info" style={{ left: '1243px', top: '70px' }}>Dinâmica dos Mecanismos<br /> </div></div>
        ...
        <div><div className="course-info" style={{ left: '1243px', top: '210px' }}>Tecnologias de Fabricação 2<br /></div></div>
        <div className="course-info" style={{ left: '1243px', top: '231px', display: 'flex', flexWrap: 'wrap', gap: '4px 6px', position: 'absolute' }}>
            <div style={{ display: 'flex', alignItems: 'center', flexShrink: '0', minWidth: '0px', maxWidth: '100%', height: '18px', borderRadius: '3px', paddingLeft: '6px', paddingRight: '6px', fontSize: '12px', lineHeight: '120%', color: 'rgb(253 253 253 / 80%)', background: 'rgb(110, 54, 48)', margin: '0px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
              <div style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'inline-flex', alignItems: 'center', height: '18px', lineHeight: '18px' }}>
                <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>4 créditos</span>
              </div>
        ...
        <div><div className="course-info" style={{ left: '1243px', top: '345px' }}>Equipamentos Termofluidos Automotivos<br /></div></div>
        ...
        <div><div className="course-info" style={{ left: '1243px', top: '615px' }}>Projeto de Elementos Automotivos<br /></div></div>
        ...
        <div className="course-info" style={{ left: '1243px', top: '750px' }}>Materiais Compostos e Plásticos<br /></div>
        ...
        <div><div className="course-info" style={{ left: '1488px', top: '70px' }}>Arquitetura de Motores de Combustão Interna<br /> </div></div>
        ...
        <div><div className="course-info" style={{ left: '1488px', top: '210px' }}>Eletrônica Veicular<br /></div></div>
        ...
        <div><div className="course-info" style={{ left: '1488px', top: '345px' }}>Projeto de Sistemas Automotivos<br /></div></div>
        ...
        <div><div className="course-info" style={{ left: '1488px', top: '480px' }}>Dinâmica de Veículos<br /></div></div> 
        ...
        <div><div className="course-info" style={{ left: '1488px', top: '615px' }}> Acústica e Vibrações Veiculares<br /></div></div>
        <div className="course-info" style={{ left: '1488px', top: '650px', display: 'flex', flexWrap: 'wrap', gap: '4px 6px', position: 'absolute' }}>
            <div style={{ display: 'flex', alignItems: 'center', flexShrink: '0', minWidth: '0px', maxWidth: '100%', height: '18px', borderRadius: '3px', paddingLeft: '6px', paddingRight: '6px', fontSize: '12px', lineHeight: '120%', color: 'rgb(253 253 253 / 80%)', background: 'rgb(110, 54, 48)', margin: '0px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
              <div style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', display: 'inline-flex', alignItems: 'center', height: '18px', lineHeight: '18px' }}>
                <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>4 créditos</span>
              </div>
        ...
        <div><div className="course-info" style={{ left: '1728px', top: '70px' }}>Análise Estrutural Método dos Elementos Finitos<br /></div></div>
        ...
        <div><div className="course-info" style={{ left: '1728px', top: '210px' }}>Projeto de Estruturas de Veículos<br /></div></div>
